  ...
  try {
    ...
    readStream.on("data", async function (r) {
      ...
      try {
        ...
        const TRADINGSYMBOL = r.TRADING_SYMBOL || r.TradingSymbol || r.SYMBOL_NAME || "";
        const canon_key = `${EXCH_ID}|${segmentNorm}|${SECURITY_ID}`;

        const doc = {
          canon_key,
          // instrument_key: canon_key, // optional: uncomment if you want to populate instrument_key
          exchange: EXCH_ID,
          segment: segmentNorm,
          securityId: SECURITY_ID,
          tradingsymbol: TRADINGSYMBOL,
          symbol_name: r.SYMBOL_NAME || r.DISPLAY_NAME || "",
          display_name: r.DISPLAY_NAME || null,
          underlying_symbol: (r.UNDERLYING_SYMBOL || "").toUpperCase() || null,
          underlying_security_id: r.UNDERLYING_SECURITY_ID || null,
          instrumentType: r.INSTRUMENT || null,
          optionType: (r.OPTION_TYPE || "").toUpperCase() || null,
          series: r.SERIES || null,
          strike: toNum(r.STRIKE_PRICE),
          expiry: toDate(r.SM_EXPIRY_DATE),
          lotSize: toNum(r.LOT_SIZE),
          tickSize: toNum(r.TICK_SIZE),
          isin: r.ISIN || null,
          meta: r
        };
